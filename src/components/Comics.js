...
class Comics extends Component {
    ...
    deleteComic=(index)=>{
        //CON EL METODO SPLICE INDICAMOS EL INDICE A ELIMINAR Y
        //EL NUMERO DE ELEMENTOS DE UNA COLECCION
    ...
    render() {
        return (
            <div>
                ...
                {
                    //SI NO ESTA CARGADO/VACIO NO CARGAMOS EL CODIGO
                    this.state.favorito &&
                    <div style={{backgroundColor:"lightgreen"}}>
                        <h4>{this.state.favorito.titulo}</h4>
                        <img src={this.state.favorito.imagen} alt="aaa" style={{width:"150px",height:"150px"}}/>
                    </div>
                }
